...
temp_before_afternoon = temperature_default + 5
temp_afternoon = temp_before_afternoon - 10
...
boys_today = boys - 1
girls_today = girls - 2
print(int(boys_today + girls_today))
...
print(int(first_book + second_book + third_book))
